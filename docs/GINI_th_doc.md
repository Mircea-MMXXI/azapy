...
# primary risk = [GINI] (redundant)
# secondary risk = [GINI] (redundant)
# risk = GINI
RR = cr1.RR
risk = cr1.risk
...
# toc = time.perf_counter()
# p4.set_model(mu=0., hlength=0.5, method='highs')
# tic = time.perf_counter()
# print(f"highs: time get_port: {tic-toc}")  


# toc = time.perf_counter()
# p4.set_model(mu=0., hlength=0.5, method='highs-ds')
# tic = time.perf_counter()
# print(f"highs-ds: time get_port: {tic-toc}")  

# toc = time.perf_counter()
# p4.set_model(mu=0., hlength=0.5, method='highs-ipm')
# tic = time.perf_counter()
