...
```
SMGINIAnalyzer(mktdata=None, colname='adjusted', freq='Q', hlength=1.25,
...
# # please uncomment the lines below
# crx1 = az.SMGINIAnalyzer(mktdata, method='ecos')
# wwx1 = crx1.getWeights(mu=0.)
# print(f"ecos : {wwx1}")
# crx2 = az.SMGINIAnalyzer(mktdata, method='cvxopt')
...
#=============================================================================
# Compute SMGINI-Sharpe optimal portfolio
p4 = az.Port_SMGINI(mktdata, pname='SMGINIPort')
...
#=============================================================================
# Compute SMGINI optimal portfolio
...
#=============================================================================
# Compute minimum SMGINI optimal portfolio
...
#=============================================================================
# Compute optimal portfolio with SMGINI of equal weighted portfolio
...
# toc = time.perf_counter()
# p4.set_model(mu=0., hlength=0.5)   
# tic = time.perf_counter()
# print(f"ecos: time get_port: {tic-toc}")  

# toc = time.perf_counter()
# p4.set_model(mu=0., hlength=0.5, method='cvxopt')
# tic = time.perf_counter()
