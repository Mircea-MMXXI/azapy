...
from .Port_InvVol_X import Port_InvVol_X


class Port_CVaR_X(Port_InvVol_X):
    """
    ...
    def _wwgen(self):
        return CVaRAnalyzer(self.alpha, self.coef, name=self.pname,
    ...
    def _ww_calc(self, data):
        model = self._wwgen()
        model.set_mktdata(data, colname=None)
