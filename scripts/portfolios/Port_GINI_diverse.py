...
rtype = "MaxDiverse"
port4 = p4.set_model(rtype=rtype)   

ww = p4.get_weights()
p4.port_view(title="Gini Max Diversified Portfolio", ylabel="price ($)")
p4.port_view_all()
p4.port_perf()
...
pp.port_view_all(componly=True, 
                 title="Gini Portfolios - Relative Performance", 
                 xlabel="year")
