...
# crx5 = az.OmegaAnalyzer(mu0=0., rrate=rrate, method='glpk')
# wwx5 = crx5.getWeights(mu=0.)
# print(f"glpk : {wwx5}")
# crx6 = az.OmegaAnalyzer(mu0=0., rrate=rrate, method='cvxopt')
# wwx6 = crx6.getWeights(mu=0.)
# print(f"cvxopt : {wwx6}")
# crx7 = az.OmegaAnalyzer(mu0=0., rrate=rrate, method='ecos')
