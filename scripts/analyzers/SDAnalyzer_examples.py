...
cr1 = az.SDAnalyzer(rrate, method='ecos')
...
sharpe1 = cr1.sharpe
# second Sharpe2
cr2 = az.SDAnalyzer(rrate, method='ecos')
...
crx1 = az.SDAnalyzer(rrate, method='ecos')
wwx1 = crx1.getWeights(mu=0.)
print(f"ecos : {wwx1}")
crx2 = az.SDAnalyzer(rrate, method='cvxopt')
